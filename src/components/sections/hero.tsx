    ...
    <SectionWrapper id="hero" className={cn("relative w-full h-screen")}>
      <div className="grid md:grid-cols-2">
            ...
            <div className="flex flex-col">
              <div>
                ...
                <BlurIn delay={1.2}>
                  ...
                  >
                    Ingénieur en formation Informatique et Réseaux (MIAGE)
                  </p>
                </BlurIn>
              </div>
        ...
        <div className="grid col-span-1 relative">
          {!isLoading && (
            <div className="h-full flex items-center justify-center md:justify-end p-8">
              <BlurIn delay={1.5}>
                <div className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full overflow-hidden border-4 border-slate-300 dark:border-zinc-700 shadow-2xl">
                  <Image
                    src="/assets/me.png"
                    alt="Mohammed Halim Benosmane"
                    fill
